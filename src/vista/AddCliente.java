...
public class AddCliente extends VentanaBasica {
	...
	private static Logger logger = Logger.getLogger(AddCliente.class);
	...
	public AddCliente() {
        ...
        es = new EventSave(this, ConstantesRMA.ACCION_CREAR_CLIENTE);
